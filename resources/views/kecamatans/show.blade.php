...
<table class="table table-bordered">
		...
		<thead>
			<tr>
				<th>{{ $kecamatan->id }}</th>
				<th>{{ $kecamatan->namaweb }}</th>
				<th><a href="{{ $kecamatan->linkweb }}">{{ $kecamatan->linkweb }}</a></th>
				<th>{{ $kecamatan->deskripsi }}</th>
				<th>{{ $kecamatan->status }}</th>
				<th>{{ $kecamatan->haripemantauan }}</th>
				<th>{{ $kecamatan->keterangan }}</th>
