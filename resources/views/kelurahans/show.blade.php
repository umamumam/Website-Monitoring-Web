...
<table class="table table-bordered">
		...
		<thead>
			<tr>
				<th>{{ $kelurahan->id }}</th>
				<th>{{ $kelurahan->namaweb }}</th>
				<th><a href="{{ $kelurahan->linkweb }}">{{ $kelurahan->linkweb }}</a></th>
				<th>{{ $kelurahan->deskripsi }}</th>
				<th>{{ $kelurahan->status }}</th>
				<th>{{ $kelurahan->haripemantauan }}</th>
				<th>{{ $kelurahan->keterangan }}</th>
