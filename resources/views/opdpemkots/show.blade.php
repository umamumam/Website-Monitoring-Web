...
<table class="table table-bordered">
		...
		<thead>
			<tr>
				<th>{{ $opdpemkot->id }}</th>
				<th>{{ $opdpemkot->namaweb }}</th>
				<th><a href="{{ $opdpemkot->linkweb }}">{{ $opdpemkot->linkweb }}</a></th>
				<th>{{ $opdpemkot->deskripsi }}</th>
				<th>{{ $opdpemkot->status }}</th>
				<th>{{ $opdpemkot->haripemantauan }}</th>
				<th>{{ $opdpemkot->keterangan }}</th>
